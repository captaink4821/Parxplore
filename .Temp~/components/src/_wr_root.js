	...
	import * as mod1 from "wrm\/comp\/DetailsService";
	...
	import * as mod3 from "wrm\/comp\/val\/EMailValidationRuleService";
	wrm.defineModule("wrm\/comp\/val\/EMailValidationRuleService", mod3)

	import * as mod4 from "wrm\/comp\/val\/MandatoryValidationRuleService";
	wrm.defineModule("wrm\/comp\/val\/MandatoryValidationRuleService", mod4)

	import * as mod5 from "wrm\/comp\/ListService";
	wrm.defineModule("wrm\/comp\/ListService", mod5)

	import * as mod6 from "wrm\/comp\/SelectorService";
	...
	import * as mod8 from "wrm\/comp\/ViewComponentService";
	wrm.defineModule("wrm\/comp\/ViewComponentService", mod8)

	import * as mod9 from "wrm\/comp\/CreateService";
	wrm.defineModule("wrm\/comp\/CreateService", mod9)

	import * as mod10 from "wrm\/comp\/UpdateService";
	wrm.defineModule("wrm\/comp\/UpdateService", mod10)

	import * as mod11 from "wrm\/comp\/SwitchService";
	wrm.defineModule("wrm\/comp\/SwitchService", mod11)

	import * as mod12 from "wrm\/comp\/RestfulRequestResponseService";
	wrm.defineModule("wrm\/comp\/RestfulRequestResponseService", mod12)

	import * as mod13 from "wrm\/comp\/DeleteService";
	wrm.defineModule("wrm\/comp\/DeleteService", mod13)

	import * as mod14 from "wrm\/comp\/LoginService";
	wrm.defineModule("wrm\/comp\/LoginService", mod14)

	import * as mod15 from "wrm\/comp\/LogoutService";
